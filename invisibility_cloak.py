...
try:
    ...
    time.sleep(2)
    bg = None  # Inicialize bg como None
    ...
    # Se bg não foi inicializado corretamente, encerre o programa
    if bg is None:
        print("Erro ao capturar o plano de fundo. Encerrando.")
        exit()
    ...
    while cap.isOpened():
        ...
        # Aguardando a tecla 'q' para sair do loop
        if cv2.waitKey(1) & 0xFF == ord('q'):
            break

finally:
    # Libere os recursos da webcam e o arquivo de saída
    cap.release()
    output_file.release()
